...
define('APP_PATH'           , YAB_APP_PATH . 'modules/' . MODULE_NAME . DS);//项目目录
...
define('ADMIN_IMGCACHE'        , 'http://imgcache.yablog.cn/v0.1/admin/');//后台imgcache
define('IMGCACHE_JS'           , 'http://imgcache.yablog.cn/v0.1/front/js/');//js url
define('IMGCACHE_CSS'          , 'http://imgcache.yablog.cn/v0.1/front/css/');//css url
define('IMGCACHE_IMG'          , 'http://imgcache.yablog.cn/v0.1/front/images/');//img url
