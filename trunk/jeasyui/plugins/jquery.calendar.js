    ...
    function getWeeks(target, year, month) {
        ...
        if (firstWeek.length < 7) {
            while (firstWeek.length < 7) {
                ...
                var date = new Date(firstDate[0], firstDate[1] - 1, firstDate[2] - 1) firstWeek.unshift([date.getFullYear(), date.getMonth() + 1, date.getDate()]);
            }
        } else {
            var firstDate = firstWeek[0];
            var week = [];
        ...
        return this.each(function() {
            ...
            if (state) {
                ...
                state = $.data(this, 'calendar', {
                    options: $.extend({},
                    $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), options)
                });
                init(this);
            }
