...
(function(){function ba(f,a,d){var c;a=a.toLowerCase();return(c=f.__allListeners||d&&(f.__allListeners={}))&&(c[a]||d&&(c[a]=[]))}function X(f,a,d,c,b,h){c=c&&f[a];var g;for(!c&&(c=f[d]);!c&&(g=(g||f).parentNode);){if("BODY"==g.tagName||h&&!h(g))return null;c=g[d]}return c&&b&&!b(c)?X(c,a,d,!1,b):c}
UEDITOR_CONFIG=window.UEDITOR_CONFIG||{};
var q=window.baidu||{};window.baidu=q;window.UE=q.editor={};UE.plugins={};UE.commands={};UE.instants={};UE.I18N={};UE.version="1.2.6.1";var K=UE.dom={},r=UE.browser=
