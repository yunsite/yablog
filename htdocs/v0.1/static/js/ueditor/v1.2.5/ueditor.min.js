(function() {
        ...
        me.addListener("keydown", function(type, evt) {
            ...
            if (!keys[keyCode] && !evt.ctrlKey && !evt.metaKey && !evt.shiftKey && !evt.altKey) {
                ...
                if (keycont >= maxInputCount || me.undoManger.mousedown) {
                    if (me.selection.getRange().collapsed) me.fireEvent("contentchange");
                    me.undoManger.save();
                ...
                if (div.firstChild) {
                    ...
                    if (f) {
                        try {
                            ...
                            var node = f.transformInput(f.parseHTML(html), word_img_flag);
    ...
    UE.plugins["list"] = function() {
        ...
        me.addListener("contentchange", function() {
            utils.each(domUtils.getElementsByTagName(me.document, "ol ul"), function(node) {
                if (!domUtils.inDoc(node, me.document)) return;
        ...
        me.addListener("tabkeydown", function() {
            ...
            var range = me.selection.getRange(), listStyle = {
    ...
    UE.plugins["table"] = function() {
            ...
            for (var i = 0, node; node = tableArr[i++]; ) {
                ...
                if (td[0]) {
                    if (flag) {
                        ...
                        if (/(#ffffff)|(rgb\(255,f55,255\))/gi.test(color)) domUtils.addClass(node, "noBorderTable");
                    } else {
        ...
        UE.commands["inserttable"] = {
            ...
            execCommand: function(cmd, opt) {
                ...
                var me = this, defaultValue = getDefaultValue(me), tableWidth = getTableWidth(me, needIEHack, defaultValue) - (firstParentBlock ? parseInt(domUtils.getXY(firstParentBlock).x, 10) : 0), tdWidth = Math.floor(tableWidth / opt.numCols - defaultValue.tdPadding * 2 - defaultValue.tdBorder);
            ...
            execCommand: function(cmd) {
                ...
                if (table) {
                    ...
                    if (cmd == "adaptbywindow") {
                        ...
                        var defaultValue = getDefaultValue(me, table);
                        var width = table.offsetWidth, bodyWidth = me.body.offsetWidth;
                        if (width > bodyWidth) {
        ...
        UETable.prototype = {
            ...
            update: function(table) {
                ...
                this.cellsRange = {};
                this.indexTable = [];
                var rows = this.table.rows, rowsNum = rows.length, colsNum = this.getMaxCols();
            ...
            updateWidth: function(width, defaultValue) {
                var table = this.table, tmpWidth = getWidth(table) - defaultValue.tdPadding * 2 - defaultValue.tdBorder + width;
    ...
    (function() {
        ...
        function getPara(me) {
            var opt = me.editor.options.autotypeset, cont = me.getDom(), ipts = domUtils.getElementsByTagName(cont, "input");
    ...
    (function() {
        ...
        var dialogBtns = {
            ...
            ok: [ "attachment", "anchor", "link", "insertimage", "map", "gmap", "insertframe", "wordimage", "insertvideo", "highlightcode", "insertframe", "edittip", "edittable", "edittd", "scrawl", "template", "music", "background" ]
        };
